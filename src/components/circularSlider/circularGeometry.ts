...
function convertAngle(degree: number, from: AngleDirection, to?: AngleDirection): number {
...
export function angleToPosition(angle: Angle, radius: number, svgSize: number): Position {
...
export function semiCircle(opts: SemiCircleOptions): string {
